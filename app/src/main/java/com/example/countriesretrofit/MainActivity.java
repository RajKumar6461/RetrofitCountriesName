...
public class MainActivity extends AppCompatActivity {
    ...
    private CountryAdapterRecycleView mCountryAdapterRecycleView;
    private ArrayList<Country> countryArrayList=new ArrayList<Country>();
    private static final String COUNTRY_ARRAY_LIST="CountryNmaeList";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Paper.book().contains(COUNTRY_ARRAY_LIST)) {
            ...
            mCountryAdapterRecycleView = new CountryAdapterRecycleView(countryArrayList);
